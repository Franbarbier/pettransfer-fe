...
const inputClass =
  "w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100";
...
export default function DemoCoti01Page(): React.JSX.Element {
  ...
  return (
    <main className="min-h-screen w-full px-6 py-6 text-zinc-900 dark:text-zinc-100">
      <button
        type="button"
        onClick={() => setPdfPreviewOpen((v) => !v)}
        className="fixed right-4 top-4 z-50 rounded-full border border-zinc-300 bg-white/95 px-3 py-2 text-xs font-medium text-zinc-800 shadow-md backdrop-blur-sm transition hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-900/95 dark:text-zinc-100 dark:hover:bg-zinc-800"
      ...
      <h1 className="text-xl font-semibold">Demo cotizaciones 0.1</h1>
      ...
      <div className="mt-8 flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-10">
        ...
        >
          ...
          >
            ...
            <div>
              <label htmlFor="dc01-customer" className={labelClass}>
                Nombre del cliente
              </label>
              <input
                id="dc01-customer"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div ref={originWrapRef} className="relative min-w-0">
                <label htmlFor="dc01-origin" className={labelClass}>
                  Origen
                </label>
                <input
                  id="dc01-origin"
              ...
              <div ref={destWrapRef} className="relative min-w-0">
                <label htmlFor="dc01-destination" className={labelClass}>
                  Destino (opcional)
                </label>
                <input
                  id="dc01-destination"
              ...
              {impoTemplates.length > 0 ? (
                <ul className="mt-3 space-y-3">
                  {impoTemplates.map((tpl) => (
                    <li
                      key={tpl.file_name}
                      className="rounded-md border border-zinc-200 bg-white p-3 dark:border-zinc-600 dark:bg-zinc-900"
                    >
                      ...
                      {tpl.quoted_items.length > 0 ? (
                        <ul className="mt-2 space-y-1 border-t border-zinc-100 pt-2 text-xs dark:border-zinc-700">
                          {tpl.quoted_items.map((it, qIdx) => {
                            ...
                            >
                              ...
                              {cust.trim() !== "" ? (
                                <p className="mt-1 whitespace-pre-wrap pl-6 text-[10px] leading-snug text-zinc-500 dark:text-zinc-400">
                                  {cust}
                                </p>
                              ) : null}
                              {it.note?.trim() ? (
                                <p className="mt-0.5 pl-6 font-mono text-[10px] text-amber-700/90 dark:text-amber-400/90">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                Cotizaciones en la base con el mismo origen{destination.trim() ? " y destino" : ""}{" "}
                (hasta 100). Igual que en{" "}
                <code className="rounded bg-zinc-200 px-1 dark:bg-zinc-800">
                  /demo-coti
                </code>
                .
              </p>
              <div className="max-h-[35vh] overflow-auto rounded-lg border border-zinc-200 dark:border-zinc-700">
                            ...
                            <tr className="border-b border-zinc-100 dark:border-zinc-800">
                              <td className="px-1 py-1 align-middle">
                                <button
                                  ...
                                  className="flex h-8 w-8 items-center justify-center rounded text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
                                  aria-expanded={open}
                                  aria-label={
                                    open
                              ...
                              <td className="max-w-[140px] px-3 py-2 text-xs text-zinc-600 dark:text-zinc-400">
            ...
            <div>
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:gap-3">
                <div className="w-full max-w-[5.75rem] shrink-0 sm:w-[5.75rem]">
                  <label htmlFor="dc01-animal-count" className={labelClass}>
                    # animales
                  </label>
                  <input
                    id="dc01-animal-count"
                    type="number"
                    min={1}
                    max={MAX_ANIMALS}
                    inputMode="numeric"
                ...
                <div className="min-w-0 flex-1">
                  <label htmlFor="dc01-quoted" className={labelClass}>
                    Quoted date
                  </label>
                  <input
                    id="dc01-quoted"
                ...
                <div className="min-w-0 flex-1">
                  <label htmlFor="dc01-arrival" className={labelClass}>
                    Arrival date
                  </label>
                  <input
                    id="dc01-arrival"
              ...
              {pets.map((pet, i) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
                    ...
                    <div>
                      <label
                        htmlFor={`dc01-pet-${i}-nombre`}
                        className={fieldLabelClass}
                      >
                        Nombre
                      </label>
                      <input
                        id={`dc01-pet-${i}-nombre`}
                        type="text"
                        autoComplete="off"
                        value={pet.nombre}
                        onChange={(e) =>
                  ...
                  {pet.crateId && latamJaulasHint ? (
                    <p
                      role="note"
                      className="mt-3 rounded-md border border-amber-200 bg-amber-50 px-2.5 py-2 text-xs leading-relaxed text-amber-950 dark:border-amber-900/40 dark:bg-amber-950/30 dark:text-amber-100"
                    >
            ...
            <hr
              className="my-8 border-0 border-t border-dashed border-zinc-300 dark:border-zinc-600"
              aria-hidden
            />
            ...
            {!origin.trim() ? (
              ...
              <div className="space-y-5">
                {latamProfitFields && latamProfitFields.fields.length > 0 ? (
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">
                      ...
                      <span className="italic">{latamProfitFields.label}</span>
                      <span className="block pt-1 text-zinc-400">
                        (sin la clave{" "}
                        <code className="text-zinc-600 dark:text-zinc-300">
                          jaulas
                        </code>
                        ; esa nota va arriba en cada mascota si aplica.)
                      </span>
                    </p>
                  </div>
                ) : (
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">
                      Cargadas desde template IMPO; podés editar, quitar o agregar
                      una fila personalizada abajo.
                    </p>
                  </div>
                )}
                <div
                ...
                >
                  {latamRows.map((row) => (
                      <div
                        key={row.id}
                        role="listitem"
                        className="flex items-start gap-2 border-b border-zinc-100 pb-5 last:border-b-0 dark:border-zinc-800"
                      >
                        <div className="min-w-0 flex-1 space-y-3">
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-3">
                            <div className="min-w-0 flex-1">
                              <label
                                htmlFor={`dc01-latam-title-${row.id}`}
                                className={fieldLabelClass}
                              >
                                Título
                              </label>
                              <input
                                id={`dc01-latam-title-${row.id}`}
                                type="text"
                                autoComplete="off"
                                value={row.title}
                                onChange={(e) =>
                            ...
                            <div className="w-full shrink-0 sm:w-[7.5rem] md:w-36">
                              <label
                                htmlFor={`dc01-latam-price-${row.id}`}
                                className={fieldLabelClass}
                              >
                                Precio
                              </label>
                              <input
                                id={`dc01-latam-price-${row.id}`}
                                type="text"
                                inputMode="decimal"
                                autoComplete="off"
                                value={row.price}
                          ...
                          {row.source === "json" || row.source === "impo" ? (
                            <p className="font-mono text-[10px] text-zinc-400 dark:text-zinc-500">
                              {row.source === "impo" ? "IMPO · " : "Clave JSON: "}
                              {row.fieldKey}
                            </p>
                          ) : null}
                          <div>
                            <label
                              htmlFor={`dc01-latam-desc-${row.id}`}
                              className={fieldLabelClass}
                            >
                              Descripción
                            </label>
                            <textarea
                              id={`dc01-latam-desc-${row.id}`}
                              rows={2}
                        ...
                        <button
                          ...
                          className="mt-7 shrink-0 rounded-md p-2 text-zinc-500 transition hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-950/40 dark:hover:text-red-300 sm:mt-8"
                ...
                <div
                  ...
                  aria-label="Agregar otro ítem"
                >
                  <div className="flex flex-col gap-3">
                  <div className="flex flex-wrap items-start gap-2">
                    <span className="mt-2 text-lg font-medium leading-none text-zinc-400 dark:text-zinc-500">
                      +
                    </span>
                    <div className="min-w-0 flex-1 space-y-1">
                      <label
                        htmlFor="dc01-latam-add-select"
                        className={fieldLabelClass}
                      >
                        Agregar campo
                      </label>
                      <select
                        id="dc01-latam-add-select"
                      ...
                      <p className="text-[11px] text-zinc-400 dark:text-zinc-500">
                        Resumen de la nota interna de referencia; el tooltip
                  ...
                  {latamCustomFormOpen ? (
                    <div className="rounded-lg border border-zinc-200 bg-zinc-50/80 p-3 dark:border-zinc-600 dark:bg-zinc-900/50">
                      ...
                      <div className="space-y-3">
                        <div>
                          <label
                            htmlFor="dc01-latam-custom-title"
                            className={fieldLabelClass}
                          >
                            Título
                          </label>
                          <input
                            id="dc01-latam-custom-title"
                            type="text"
                        ...
                        <div>
                          <label
                            htmlFor="dc01-latam-custom-desc"
                            className={fieldLabelClass}
                          >
                            Descripción
                          </label>
                          <textarea
                            id="dc01-latam-custom-desc"
                            rows={3}
                            value={latamCustomDesc}
                            onChange={(e) =>
                              setLatamCustomDesc(e.target.value)
                            }
                            className={`${inputClass} min-h-[4.5rem] resize-y font-sans`}
            ...
            <div className="space-y-5">
              <div>
                <label
                  htmlFor="dc01-disclaimer-contract"
                  className={labelClass}
                >
                  Conditions of contract
                </label>
                <textarea
                  id="dc01-disclaimer-contract"
                  rows={5}
              ...
              <div>
                <label
                  htmlFor="dc01-disclaimer-contact"
                  className={labelClass}
                >
                  Contact
                </label>
                <textarea
                  id="dc01-disclaimer-contact"
                  rows={3}
        ...
        >
          <div
            id="dc01-right-pane"
            className="h-fit w-full rounded-[20px] bg-white py-[10%] px-[7%]"
          >
              ...
              <div className="w-full">
                {rightPaneBudgetLines.length === 0 ? (
                  ...
                  rightPaneBudgetLines.map((line) => (
                    <div
                      key={line.id}
                      className="flex flex-row items-start justify-between gap-2 border-b border-[#e3e3e3] py-1"
                    >
                      ...
                      <div className="min-w-[4rem] shrink-0 self-start">
                        {line.kind === "latam" ? (
                          <input
                            type="text"
                            inputMode="decimal"
            ...
            <hr
              className="my-3 border-0 border-t border-dashed border-[#d4d4d4]"
              aria-hidden
            />
            <div
